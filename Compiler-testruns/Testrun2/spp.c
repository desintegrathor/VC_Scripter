...
int ScriptMain(s_SC_OBJ_info *info){
	...
	switch(info->event_type){
		case 3:			
			...
			einfo.min_rx = (-40.0f*0.0174532925199f);
			einfo.max_rx = (60.0f*0.0174532925199f);
			einfo.min_rz = (-120.0f*0.0174532925199f);
			einfo.max_rz = (120.0f*0.0174532925199f);
