...
int32_t GUESSED_g_flag_15 = 0;  // data[15], GUESSED: no reliable constant match (confidence: 0.00)
int32_t GUESSED_g_flag_100 = 0;  // data[100], GUESSED: no reliable constant match (confidence: 0.00)
int32_t GUESSED_g_flag_124 = 0;  // data[124], GUESSED: no reliable constant match (confidence: 0.00)
int32_t GUESSED_g_flag_125 = 0;  // data[125], GUESSED: no reliable constant match (confidence: 0.00)
int32_t GUESSED_g_flag_126 = 0;  // data[126], GUESSED: no reliable constant match (confidence: 0.00)
int32_t GUESSED_g_flag_127 = 0;  // data[127], GUESSED: no reliable constant match (confidence: 0.00)
int32_t GUESSED_g_flag_129 = 1;  // data[129], GUESSED: no reliable constant match (confidence: 0.00)
int32_t g_arrivalUnlocked = SGI_ARRIVAL_UNLOCKED;  // data[130] = 1084227584, from SGI_ARRIVAL_UNLOCKED
int32_t GUESSED_g_flag_132 = 0;  // data[132], GUESSED: no reliable constant match (confidence: 0.00)
int32_t GUESSED_g_flag_135 = 0;  // data[135], GUESSED: no reliable constant match (confidence: 0.00)
int32_t g_maxshootdist_256 = MAXSHOOTDIST;  // data[256] = 100, from MAXSHOOTDIST (confidence: 0.85)
int32_t GUESSED_g_flag_4233 = 0;  // data[4233], GUESSED: no reliable constant match (confidence: 0.00)
...
void func_2802(void) {
  SC_P_IsReady(705 + GUESSED_g_flag_129);  // 2805
}
void func_2815(void) {
  int32_t local_277;
...
void func_3021(void) {
  SC_P_IsReady(751 + GUESSED_g_flag_129);  // 3024
}
void func_3034(void) {
  int32_t local_268;
...
void func_3130(void) {
  SC_P_IsReady(769 + GUESSED_g_flag_129);  // 3133
  SC_MP_EndRule_SetTimeLeft();  // 3141
  func_3155();  // 3142
}
void func_3151(void) {
  SC_P_IsReady(773 + GUESSED_g_flag_129);  // 3154
}
void func_3164(void) {
  int32_t local_265;
...
void func_3251(void) {
  SC_P_IsReady(788 + GUESSED_g_flag_129);  // 3254
}
void func_3264(void) {
  int32_t local_265;
...
void func_3351(void) {
  SC_P_IsReady(803 + GUESSED_g_flag_129);  // 3354
}
void func_3364(void) {
  int32_t local_271;
...
void func_3491(void) {
  SC_P_IsReady(828 + GUESSED_g_flag_129);  // 3494
}
void func_3504(void) {
  int32_t local_265;
...
void func_3586(void) {
  SC_P_IsReady(842 + GUESSED_g_flag_129);  // 3589
}
void func_3599(void) {
  int32_t local_265;
...
void func_3681(void) {
  SC_P_IsReady(856 + GUESSED_g_flag_129);  // 3684
}
void func_3694(void) {
  int32_t local_345;
...
void func_3823(void) {
  ...
  func_3844();  // 3826
  SC_P_IsReady((void*)g_allydeathcount + GUESSED_g_flag_124);  // 3834
  func_3844();  // 3838
  SC_P_IsReady((char*)876 % 133 + GUESSED_g_flag_124);  // 3843
  SRS(0, 0);  // 3846
  func_3863();  // 3847
  SC_P_IsReady((void*)g_allydeathcount + GUESSED_g_flag_135);  // 3855
  func_3861();  // 3859
  if (!(1)) {
    SC_P_IsReady((void*)g_allydeathcount + GUESSED_g_flag_135);  // 3870
  }
...
void func_4259(void) {
  if ((char*)978) {
    SC_P_IsReady(979 + GUESSED_g_flag_135);  // 4271
  } else {
    SC_P_IsReady(979 + GUESSED_g_flag_135);  // 4271
  }
  SC_P_IsReady(980 + GUESSED_g_flag_135);  // 4276
  SC_P_ChangeWeapon();  // 4330
  SC_P_IsReady(995 + g_arrivalUnlocked);  // 4334
  SC_P_IsReady(996 + GUESSED_g_flag_129);  // 4338
}
void func_4339(void) {
  int stack_tmp_0;
...
void func_4363(void) {
  ...
  SC_P_IsReady(SGI_LEVPILOT_S1G5 + GUESSED_g_flag_129);  // 4371
...
void func_4446(void) {
  ...
  SC_P_IsReady(1043 + GUESSED_g_flag_129);  // 4454
...
void func_4534(void) {
  ...
  SC_P_IsReady(1087 + GUESSED_g_flag_129);  // 4542
...
void func_4634(void) {
  ...
  SC_P_IsReady(1139 + GUESSED_g_flag_129);  // 4642
...
void func_4734(void) {
  ...
  SC_P_IsReady(1191 + GUESSED_g_flag_129);  // 4742
...
void func_4834(void) {
  ...
  SC_P_IsReady(1243 + GUESSED_g_flag_129);  // 4842
...
void func_4934(void) {
  ...
  SC_P_IsReady(1295 + GUESSED_g_flag_129);  // 4942
...
void func_5034(void) {
  ...
  SC_P_IsReady(1347 + GUESSED_g_flag_129);  // 5042
...
void func_5146(void) {
  ...
  SC_P_IsReady(1414 + GUESSED_g_flag_129);  // 5177
...
void func_5206(void) {
  ...
  SC_P_IsReady(g_allydeathcount + GUESSED_g_flag_125);  // 5221
  SC_P_IsReady(g_allydeathcount + GUESSED_g_flag_126);  // 5227
  SC_P_IsReady(1421 + GUESSED_g_flag_127);  // 5231
  SC_P_IsReady(SC_P_IsReady(1421 + GUESSED_g_flag_127));  // 5234
}
void func_5237(void) {
}
void func_5391(void) {
