...
int32_t g_flag_2 = 0;  // data[2], used in 1 location(s)
int32_t g_flag_3 = 0;  // data[3], used in 11 location(s)
int32_t g_flag_4 = 0;  // data[4], used in 12 location(s)
int32_t g_flag_5 = 0;  // data[5], used in 3 location(s)
int32_t g_flag_8 = 0;  // data[8], used in 1 location(s)
int32_t g_flag_9 = 0;  // data[9], used in 1 location(s)
...
int32_t g_var_256 = 100;  // data[256], used in 12 location(s)
...
void func_2170(void) {
  ...
  SC_P_IsReady(&g_flag_5 + 609);  // 2184
  SC_P_IsReady(SC_P_IsReady(&g_flag_5 + 609) + 610);  // 2188
...
void main(void) {
  ...
  SC_P_IsReady(&g_var_256 + 660);  // 2524
...
void func_2717(void) {
  ...
  SC_P_IsReady(&g_var_256 + 693);  // 2727
...
void func_2815(void) {
  ...
  SC_P_IsReady(&g_var_256 + 707);  // 2829
...
void func_3034(void) {
  ...
  SC_P_IsReady(&g_var_256 + 753);  // 3045
...
void func_3164(void) {
  ...
  SC_P_IsReady(&g_var_256 + 775);  // 3174
...
void func_3264(void) {
  ...
  SC_P_IsReady(&g_var_256 + 790);  // 3274
...
void func_3364(void) {
  ...
  SC_P_IsReady(&g_var_256 + 805);  // 3376
...
void func_3504(void) {
  ...
  SC_P_IsReady(&g_var_256 + 830);  // 3514
...
void func_3599(void) {
  ...
  SC_P_IsReady(&g_var_256 + 844);  // 3609
...
void func_3823(void) {
  ...
  func_3844();  // 3826
  SC_P_IsReady((void*)g_flag_4 + g_flag_124);  // 3834
  func_3844();  // 3838
  SC_P_IsReady((char*)876 % 133 + g_flag_124);  // 3843
  SRS(0, 0);  // 3846
  func_3863();  // 3847
  SC_P_IsReady((void*)g_flag_4 + g_flag_135);  // 3855
  func_3861();  // 3859
  if (!(1)) {
    SC_P_IsReady((void*)g_flag_4 + g_flag_135);  // 3870
  }
...
void func_4339(void) {
  ...
  if (stack_tmp_0) {
    SC_P_IsReady((void*)g_flag_4 + g_var_130);  // 4352
    func_4376();  // 4356
    func_4363();  // 4361
  }
}
void func_4363(void) {
  ...
  SC_P_IsReady(1007 + g_var_130);  // 4375
}
void func_4424(void) {
}
void func_4446(void) {
...
void func_5146(void) {
  ...
  if (stack_tmp_0) {
    SC_P_IsReady((void*)g_flag_4 + g_var_130);  // 5159
    SC_P_IsReady(SC_P_IsReady((void*)g_flag_4 + g_var_130) + 1404);  // 5163
    func_5182();  // 5167
  }
...
void func_5206(void) {
  ...
  SC_P_IsReady(g_flag_4 + g_flag_125);  // 5221
  SC_P_IsReady(g_flag_4 + g_flag_126);  // 5227
...
void func_5650(void) {
  SC_P_IsReady(g_var_0 + (1534.0 | g_flag_4));  // 5658
  *g_flag_4 = 1539;  // 5668
...
void func_5772(void) {
  SC_P_IsReady(g_var_0 + (1580.0 | g_flag_4));  // 5780
  *g_flag_4 = 1585;  // 5790
...
void func_5826(void) {
  ...
  func_5874();  // 5833
  SC_P_IsReady(g_flag_4 + 1610);  // 5837
...
void func_5952(void) {
  ...
  if (stack_tmp_0) {
    func_5968();  // 5961
    SC_P_IsReady(local_4 - local_4 + g_flag_4 - 1631);  // 5966
  }
}
void func_5968(void) {
