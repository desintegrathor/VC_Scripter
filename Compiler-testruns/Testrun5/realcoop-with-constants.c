...
int32_t g_var_0 = 8782016;  // data[0], used in 2 location(s)
int32_t g_var_1 = 8785440;  // data[1], used in 22 location(s)
int32_t g_false = 0;  // data[2], maybe: FALSE? (confidence: 0.90)
int32_t g_false = 0;  // data[3], maybe: FALSE? (confidence: 0.90)
int32_t g_false = 0;  // data[4], maybe: FALSE? (confidence: 0.90)
int32_t g_false = 0;  // data[5], maybe: FALSE? (confidence: 0.90)
int32_t g_false = 0;  // data[8], maybe: FALSE? (confidence: 0.90)
int32_t g_false = 0;  // data[9], maybe: FALSE? (confidence: 0.90)
int32_t g_false = 0;  // data[15], maybe: FALSE? (confidence: 0.90)
int32_t g_false = 0;  // data[100], maybe: FALSE? (confidence: 0.90)
int32_t g_false = 0;  // data[124], maybe: FALSE? (confidence: 0.90)
int32_t g_false = 0;  // data[125], maybe: FALSE? (confidence: 0.90)
int32_t g_false = 0;  // data[126], maybe: FALSE? (confidence: 0.90)
int32_t g_false = 0;  // data[127], maybe: FALSE? (confidence: 0.90)
int32_t g_true = 1;  // data[129], maybe: TRUE? (confidence: 0.90)
int32_t g_var_130 = 1084227584;  // data[130], used in 11 location(s)
int32_t g_false = 0;  // data[132], maybe: FALSE? (confidence: 0.90)
int32_t g_false = 0;  // data[135], maybe: FALSE? (confidence: 0.90)
int32_t g_maxshootdist = 100;  // data[256], maybe: MAXSHOOTDIST? (confidence: 0.90)
int32_t g_false = 0;  // data[4233], maybe: FALSE? (confidence: 0.90)
...
void func_1938(void) {
  SC_P_IsReady(&g_var_1 + 573);  // 1945
  SC_P_IsReady(SC_P_IsReady(&g_var_1 + 573) + 574);  // 1949
}
void func_1984(void) {
}
void func_1993(void) {
...
void func_2170(void) {
  ...
  SC_P_IsReady(&g_false + 609);  // 2184
  SC_P_IsReady(SC_P_IsReady(&g_false + 609) + 610);  // 2188
...
void main(void) {
  ...
  SC_P_IsReady(&g_maxshootdist + 660);  // 2524
...
void func_2717(void) {
  ...
  SC_P_IsReady(&g_maxshootdist + 693);  // 2727
  SC_P_ChangeWeapon();  // 2734
  SC_P_IsReady(local_265);  // 2735
  SC_P_IsReady(1395u);  // 2750
}
void func_2802(void) {
  SC_P_IsReady(705 + g_true);  // 2805
}
void func_2815(void) {
  int32_t local_277;

  SC_P_IsReady(&g_maxshootdist + 707);  // 2829
...
void func_3021(void) {
  SC_P_IsReady(751 + g_true);  // 3024
}
void func_3034(void) {
  int32_t local_268;

  SC_P_IsReady(&g_maxshootdist + 753);  // 3045
...
void func_3823(void) {
  ...
  func_3844();  // 3826
  SC_P_IsReady((void*)g_false + g_false);  // 3834
  func_3844();  // 3838
  SC_P_IsReady((char*)876 % 133 + g_false);  // 3843
  SRS(0, 0);  // 3846
  func_3863();  // 3847
  SC_P_IsReady((void*)g_false + g_false);  // 3855
  func_3861();  // 3859
  if (!(1)) {
    SC_P_IsReady((void*)g_false + g_false);  // 3870
  }
  ...
  SC_P_IsReady((&g_var_1 != &g_var_1) + local_345);  // 3918
  SC_P_IsReady((&g_var_1 != &g_var_1) + local_345);  // 3925
  SC_P_IsReady(SC_P_IsReady((&g_var_1 != &g_var_1) + local_345) + 888);  // 3929
}
void func_3966(void) {
}
void func_3980(void) {
...
void func_4259(void) {
  if ((char*)978) {
    SC_P_IsReady(979 + g_false);  // 4271
  } else {
    SC_P_IsReady(979 + g_false);  // 4271
  }
  SC_P_IsReady(980 + g_false);  // 4276
  SC_P_ChangeWeapon();  // 4330
  SC_P_IsReady(995 + g_var_130);  // 4334
  SC_P_IsReady(996 + g_true);  // 4338
}
void func_4339(void) {
  int stack_tmp_0;

  if (stack_tmp_0) {
    SC_P_IsReady((void*)g_false + g_var_130);  // 4352
    func_4376();  // 4356
    func_4363();  // 4361
  }
}
void func_4363(void) {
  ...
  SC_P_IsReady(SGI_LEVPILOT_S1G5 + g_true);  // 4371
  SC_P_IsReady(BTN_BRIEFING + g_var_130);  // 4375
}
void func_4424(void) {
}
void func_4446(void) {
  SC_P_ChangeWeapon();  // 4450
  SC_P_IsReady(1043 + g_true);  // 4454
  SC_P_IsReady(1044 + g_var_130);  // 4458
}
void func_4512(void) {
}
void func_4534(void) {
  SC_P_ChangeWeapon();  // 4538
  SC_P_IsReady(1087 + g_true);  // 4542
  SC_P_IsReady(1088 + g_var_130);  // 4546
}
void func_4612(void) {
}
void func_4634(void) {
  SC_P_ChangeWeapon();  // 4638
  SC_P_IsReady(1139 + g_true);  // 4642
  SC_P_IsReady(1140 + g_var_130);  // 4646
}
void func_4712(void) {
}
void func_4734(void) {
  SC_P_ChangeWeapon();  // 4738
  SC_P_IsReady(1191 + g_true);  // 4742
  SC_P_IsReady(1192 + g_var_130);  // 4746
}
void func_4812(void) {
}
void func_4834(void) {
  SC_P_ChangeWeapon();  // 4838
  SC_P_IsReady(1243 + g_true);  // 4842
  SC_P_IsReady(1244 + g_var_130);  // 4846
}
void func_4912(void) {
}
void func_4934(void) {
  SC_P_ChangeWeapon();  // 4938
  SC_P_IsReady(1295 + g_true);  // 4942
  SC_P_IsReady(1296 + g_var_130);  // 4946
}
void func_5012(void) {
}
void func_5034(void) {
  SC_P_ChangeWeapon();  // 5038
  SC_P_IsReady(1347 + g_true);  // 5042
  SC_P_IsReady(1348 + g_var_130);  // 5046
}
void func_5112(void) {
}
void func_5146(void) {
  ...
  if (stack_tmp_0) {
    SC_P_IsReady((void*)g_false + g_var_130);  // 5159
    SC_P_IsReady(SC_P_IsReady((void*)g_false + g_var_130) + 1404);  // 5163
    func_5182();  // 5167
  }
  SC_P_ChangeWeapon();  // 5172
  SC_P_IsReady(1414 + g_true);  // 5177
  SC_P_IsReady(1415 + g_var_130);  // 5181
}
void func_5182(void) {
  int32_t local_345;
  int stack_tmp_0;
...
void func_5206(void) {
  ...
  SC_P_IsReady(g_false + g_false);  // 5221
  SC_P_IsReady(g_false + g_false);  // 5227
  SC_P_IsReady(1421 + g_false);  // 5231
  SC_P_IsReady(SC_P_IsReady(1421 + g_false));  // 5234
}
void func_5237(void) {
}
void func_5391(void) {
...
void func_5650(void) {
  SC_P_IsReady(g_var_0 + (1534.0 | g_false));  // 5658
  *g_false = 1539;  // 5668
...
void func_5772(void) {
  SC_P_IsReady(g_var_0 + (1580.0 | g_false));  // 5780
  *g_false = 1585;  // 5790
...
void func_5826(void) {
  ...
  func_5874();  // 5833
  SC_P_IsReady(g_false + 1610);  // 5837
...
void func_5952(void) {
  ...
  if (stack_tmp_0) {
    func_5968();  // 5961
    SC_P_IsReady(local_4 - local_4 + g_false - 1631);  // 5966
  }
}
void func_5968(void) {
