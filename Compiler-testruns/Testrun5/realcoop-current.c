...
void func_28(void) {
  ...
  while (1) {
    ...
    func_1();  // 47
    xfn_99();  // 48
    *local_259 = (void*)0x95;  // 52
    func_3();  // 58
    *(void*)0x96 = (void*)0x98;  // 62
    func_3();  // 68
    *(void*)0x99 = (void*)0x9b;  // 72
    func_3();  // 78
    *(void*)0x9c = (void*)0x9e;  // 82
    func_3();  // 88
    *(void*)0x9f = (void*)0xa1;  // 92
    func_3();  // 98
    func_1();  // 105
    func_1();  // 106
  ...
  *local_18 = (void*)0x227;  // 1840
  ...
  func_1();  // 2109
  xfn_2162();  // 2113
  *(local_269 + 596 <= 597) = (void*)0x256;  // 2117
}
void main(void) {
  int local_17;
...
void func_2543(void) {
  ...
  while (1) {
    ...
    func_1();  // 2562
    xfn_2612();  // 2563
    *local_265 = (void*)0x29b;  // 2567
    break;  // 2571 (always true)
    func_2();  // 2572
    break;  // 2578 (always true)
    func_3();  // 2580
    xfn_2612();  // 2581
    *local_265 = (void*)0x29d;  // 2585
    break;  // 2590 (always true)
    func_3();  // 2591
    *(void*)0x29e = (void*)0x2a0;  // 2595
    break;  // 2600 (always true)
    func_3();  // 2601
    *(void*)0x2a1 = (void*)0x2a3;  // 2605
