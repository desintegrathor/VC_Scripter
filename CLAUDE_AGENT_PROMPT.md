...
**DŮLEŽITÉ**: Původní dekompilátor byl kompletně smazán a začínáme od začátku s mnohem lepší dokumentací kompilačního řetězce získanou pomocí reverse engineeringu.
...
- `tools/xfn_protos.py` - Prototypy externích funkcí
...
### Dekompilátor (ZAČÍNÁME OD ZAČÁTKU):
Původní dekompilátor byl kompletně smazán. Začínáme znovu s mnohem lepší dokumentací a pochopením systému.
