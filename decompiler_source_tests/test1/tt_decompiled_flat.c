...
int ScriptMain(s_SC_NET_info *info) {
    ...
    case 3:
        ...
        case 1:
            ...
            case 1:
                ...
                for (ptr = gCurStep - 1; ptr < gCurStep; ptr = ptr + 1) {
                    if (SC_IsNear3D(&vec, &gStepSwitch[ptr], tmp109)) {
                        if (ptr) {
                            gCurStep = ptr;
                            t1595_ret = SC_MP_GetHandleofPl(t1593_);
                            SC_sgi(t1593_, SC_MP_GetHandleofPl(t1593_));
        ...
        for (ptr28 = 0; ptr28 < 2; ptr28 = ptr28 + 1) {
            local_9 = 0;
            local_10 = 0;
            (&gRecTimer) + ptr28 * 768 + ptr * 128 + ptr45 * 4 -= info->elapsed_time;
            local_10 = ptr45 + 1;
            local_9 = ptr + 1;
            local_8 = ptr28 + 1;
        }
    ...
    case 1:
        ...
        for (ptr45 = 0; ptr45 < 2; ptr45 = ptr45 + 1) {
            if (ptr45) {
                local_294 = 68;
            } else {
                local_294 = 65;
            ...
            local_9 = 0;
            local_8 = 0;
            t2484_ret = sprintf(local_0, "TT_%c%d_%d", ptr55, ptr, ptr28);
            if (SC_NET_FillRecover((&gRec) + ptr45 * 3072 + ptr * 512 + tmp353 * 16, local_0)) {
                gRecs[ptr45] + ptr * 4++;
            } else {
                local_8 = ptr28 + 1;
            }
            if (tmp377) {
                local_8 = 32 - tmp382;
                SC_MP_GetRecovers(tmp388, (&gRec) + ptr45 * 3072 + ptr * 512 + tmp397 * 16, &local_8);
                gRecs[ptr45] + ptr * 4 += ptr28;
            } else {
                local_9 = ptr + 1;
            }
            local_10 = ptr45 + 1;
