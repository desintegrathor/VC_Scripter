...
int ScriptMain(s_SC_NET_info *info) {
    ...
    case 3:
        ...
        local_9 = 0;
        local_10 = 0;
        gRecTimer[768] + ptr40 * 128 + ptr45 * 4 -= info->elapsed_time;
        local_10 = ptr45 + 1;
        local_9 = ptr40 + 1;
        local_8 = ptr27 + 1;
        ...
        local_9 = gCurStep - 1;
        t1576_ret = SC_IsNear3D(&vec, &gStepSwitch[ptr40], tmp109);
        gCurStep = ptr40;
    ...
    case 1:
        ...
        local_8 = 0;
        t2286_ret = sprintf(&n, "TT_flag_%d", ptr32);
        local_295 = SC_NOD_GetNoMessage(0, &local_0);
        SC_NOD_GetPivotWorld(ptr54, &gFlagPos[ptr32]);
        gFlagNod[ptr32].field_0 = SC_NOD_Get(ptr54, &tmp285);
        gFlagNod[ptr32].field_4 = SC_NOD_Get(ptr54, &tmp286);
        gFlagNod[ptr32].field_8 = SC_NOD_Get(ptr54, &tmp287);
        local_8 = ptr32 + 1;
        ...
        local_9 = 0;
        local_8 = 0;
        t2484_ret = sprintf(&local_0, "TT_%c%d_%d", ptr55, ptr42, ptr27);
        t2513_ret = SC_NET_FillRecover(&gRec[3072] + ptr42 * 512 + tmp353 * 16, &local_0);
        gRecs[ptr46] + ptr42 * 4++;
        local_8 = ptr27 + 1;
        local_8 = 32 - tmp382;
        SC_MP_GetRecovers(tmp388, &gRec[3072] + ptr42 * 512 + tmp397 * 16, &local_8);
        gRecs[ptr46] + ptr42 * 4 += ptr27;
        local_9 = ptr42 + 1;
        local_10 = ptr46 + 1;
        gSteps = 0;
        local_8 = 0;
    ...
    case 6:
        ...
        local_10 = gCurStep;
        local_10 = gSteps - 1;
        local_8 = SC_MP_SRV_GetBestDMrecov(&gRec[3072] + ptr45 * 512, tmp577, &gRecTimer[768] + ptr45 * 128, 3.0f);
        gRecTimer[768] + ptr45 * 128 + ptr27 * 4 = 3.0f;
        ptr66 = tmp596;
        break;
    case 10:
        gTime = 0;
