...
[SWITCH]   Producer: LCP
Error: 'SSAFunction' object has no attribute 'ssa_blocks'
Traceback (most recent call last):
  File "<frozen runpy>", line 198, in _run_module_as_main
  File "<frozen runpy>", line 88, in _run_code
  File "C:\Users\flori\source\repos\VC_Scripter\vcdecomp\__main__.py", line 1029, in <module>
    main()
    ~~~~^^
  File "C:\Users\flori\source\repos\VC_Scripter\vcdecomp\__main__.py", line 311, in main
    cmd_structure(args)
    ~~~~~~~~~~~~~^^^^^^
  File "C:\Users\flori\source\repos\VC_Scripter\vcdecomp\__main__.py", line 565, in cmd_structure
    text = format_structured_function_named(ssa_func, func_name, func_start, func_end, function_bounds=func_bounds)
  File "C:\Users\flori\source\repos\VC_Scripter\vcdecomp\core\ir\structure\orchestrator.py", line 274, in format_structured_function_named
    switch_patterns = _detect_switch_patterns(ssa_func, func_block_ids, formatter, start_to_block)
  File "C:\Users\flori\source\repos\VC_Scripter\vcdecomp\core\ir\structure\patterns\switch_case.py", line 518, in _detect_switch_patterns
    mod_inst = _find_mod_in_predecessors(current_block, ssa_func, max_depth=2)
  File "C:\Users\flori\source\repos\VC_Scripter\vcdecomp\core\ir\structure\patterns\switch_case.py", line 73, in _find_mod_in_predecessors
    ssa_block = ssa_func.ssa_blocks.get(block_id)
                ^^^^^^^^^^^^^^^^^^^
AttributeError: 'SSAFunction' object has no attribute 'ssa_blocks'
