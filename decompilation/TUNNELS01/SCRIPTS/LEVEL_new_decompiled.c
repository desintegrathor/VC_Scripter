...
Traceback (most recent call last):
  ...
  File "C:\Users\flori\source\repos\VC_Scripter\vcdecomp\core\ir\expr.py", line 2476, in format_block_expressions
    store_text = formatter._format_store(inst)
  File "C:\Users\flori\source\repos\VC_Scripter\vcdecomp\core\ir\expr.py", line 1605, in _format_store
    rendered0 = call_expr_override if call_expr_override else self._render_value(inst.inputs[0])
                                                              ~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^
  File "C:\Users\flori\source\repos\VC_Scripter\vcdecomp\core\ir\expr.py", line 1072, in _render_value
    return self._inline_expression(value, context, parent_operator)
           ~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "C:\Users\flori\source\repos\VC_Scripter\vcdecomp\core\ir\expr.py", line 1886, in _inline_expression
