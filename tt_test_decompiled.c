...
DEBUG: func_0050 entry=50 end=79 blocks=6
DEBUG FieldTracker: Checking func_name='SC_MP_SRV_GetAtgSettings' (from 'SC_MP_SRV_GetAtgSettings(*s_SC_MP_SRV_AtgSettings)void')
DEBUG FieldTracker: Found known function SC_MP_SRV_GetAtgSettings, scanning for LADR
DEBUG FieldTracker: local_1 detected as s_SC_MP_SRV_AtgSettings (from SC_MP_SRV_GetAtgSettings, param 0)
DEBUG FieldTracker: Checking func_name='SC_MP_SRV_GetAtgSettings' (from 'SC_MP_SRV_GetAtgSettings(*s_SC_MP_SRV_AtgSettings)void')
...
DEBUG variables.py: Added field_tracker var local_285 -> s_SC_MP_SRV_settings
DEBUG variables.py: Added field_tracker var local_14 -> s_SC_MP_hud
DEBUG: func_0334 entry=334 end=350 blocks=5
DEBUG FieldTracker: Checking func_name='SC_MP_SRV_GetAtgSettings' (from 'SC_MP_SRV_GetAtgSettings(*s_SC_MP_SRV_AtgSettings)void')
DEBUG FieldTracker: Found known function SC_MP_SRV_GetAtgSettings, scanning for LADR
DEBUG FieldTracker: local_1 detected as s_SC_MP_SRV_AtgSettings (from SC_MP_SRV_GetAtgSettings, param 0)
DEBUG FieldTracker: Checking func_name='SC_MP_SRV_GetAtgSettings' (from 'SC_MP_SRV_GetAtgSettings(*s_SC_MP_SRV_AtgSettings)void')
...
DEBUG SWITCH: Aliasing detected, continuing chain
...
DEBUG SWITCH: Checking block 57 for switch pattern (start addr: 358)// Structured decompilation of decompiler_source_tests/test1/tt.scr
// Functions: 15
...
DEBUG SWITCH: Checking block 171 for switch pattern (start addr: 1161)
DEBUG SWITCH: First case - variable: gCLN_ShowInfo, SSA: t1161_0
...
DEBUG SWITCH: Checking block 245 for switch pattern (start addr: 1757)
DEBUG SWITCH: First case - variable: gCLN_ShowInfo, SSA: t1757_0
...
DEBUG SWITCH: Checking block 257 for switch pattern (start addr: 1863)
DEBUG SWITCH: First case - variable: func_1866(...), SSA: t1867_0
...
DEBUG SWITCH: Checking block 408 for switch pattern (start addr: 3407)
DEBUG SWITCH: First case - variable: gCLN_ShowInfo, SSA: t3407_0
...
DEBUG SWITCH: Checking block 434 for switch pattern (start addr: 3544)
DEBUG SWITCH: First case - variable: gMission_phase, SSA: t3544_0
...
DEBUG SWITCH: Checking block 441 for switch pattern (start addr: 3576)
